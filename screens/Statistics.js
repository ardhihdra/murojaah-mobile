    ...
    <SafeAreaView style={[mainSpace.safeArea]}>
      <ScrollView>
        <View style={styles.section}>
          ...
          <Text style={mainText.baseHeader}>{STRINGS.weekly_progress[language]}</Text>
          ...
          {/* <Text style={mainText.baseHeader}>Yearly Progress</Text> */}
          {/* <View style={{marginVertical: 12}}>
            <ContributionGraph
              values={commitsData}
          ...
          <Text style={mainText.baseHeader}>{STRINGS.mistakes_ratio[language]}</Text>
          <View style={{marginVertical: 12}}>
            {
                !loading ? 
                <>
